...
//   labelYear.className = "";
// }
// let summary = currentDate.getTime() - dateEntry.getTime();
// summary = summary / (1000 * 3600 * 24);

// let years = Math.floor(summary / 365),
//   months = Math.floor(summary % 365) / 30,
//   days = Math.floor((summary % 365) % 30);

// if (years == NaN || months == undefined || days == NaN) {
//   //   console.log("Invalid");
// } else {
//   spanYear.innerHTML = years;
//   spanMonth.innerHTML = months;
